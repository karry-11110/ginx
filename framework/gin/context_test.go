...
import (
    ...
    testdata "github.com/karry-11110/ginx/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
    ...
    assert.Regexp(t, "^(.*/vendor/)?github.com/karry-11110/ginx/framework/gin.handlerNameTest$", c.HandlerName())
}
