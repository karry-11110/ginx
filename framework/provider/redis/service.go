...
// GinxRedis 代表ginx框架的redis实现
type GinxRedis struct {
...
// NewGinxRedis 代表实例化Client
func NewGinxRedis(params ...interface{}) (interface{}, error) {
...
func (app *GinxRedis) GetClient(option ...contract.RedisOption) (*redis.Client, error) {
	// 读取默认配置
