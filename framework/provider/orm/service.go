...
// GinxGorm 代表ginx框架的orm实现
type GinxGorm struct {
...
// NewGinxGorm 代表实例化Gorm
func NewGinxGorm(params ...interface{}) (interface{}, error) {
...
// GetDB 获取DB实例
func (app *GinxGorm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
