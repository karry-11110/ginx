...
func NewGinxTraceService(params ...interface{}) (interface{}, error) {
	c := params[0].(framework.Container)
	idService := c.MustMake(contract.IDKey).(contract.IDService)
	return &GinxTraceService{idService: idService}, nil
}

// WithTrace register new trace to context
func (t *GinxTraceService) WithTrace(c context.Context, trace *contract.TraceContext) context.Context {
...
func (t *GinxTraceService) GetTrace(c context.Context) *contract.TraceContext {
	if ginC, ok := c.(*gin.Context); ok {
...
func (t *GinxTraceService) NewTrace() *contract.TraceContext {
...
func (t *GinxTraceService) StartSpan(tc *contract.TraceContext) *contract.TraceContext {
...
// GetTrace By Http
func (t *GinxTraceService) ExtractHTTP(req *http.Request) *contract.TraceContext {
	tc := &contract.TraceContext{}
...
// Set Trace to Http
func (t *GinxTraceService) InjectHTTP(req *http.Request, tc *contract.TraceContext) *http.Request {
...
func (t *GinxTraceService) ToMap(tc *contract.TraceContext) map[string]string {
	m := map[string]string{}
	if tc == nil {
		return m
	}
...
// func (t *GinxTraceService) SetTraceIDService(service contract.IDService) {
// 	t.traceIDGenerator = service
// }

// func (t *GinxTraceService) SetSpanIDService(service contract.IDService) {
