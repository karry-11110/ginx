...
type Trace interface {
	// // SetTraceIDService set TraceID generator, default ginxIDGenerator
	// SetTraceIDService(IDService)
	// // SetTraceIDService set SpanID generator, default ginxIDGenerator
